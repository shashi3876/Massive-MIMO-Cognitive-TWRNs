...
eta1=1/16;
eta2=1/16;
eta_k1=2*[1 1.02 1.01 1 1.01 1.02 0.97 1];
eta_k2=2*[1 1.04 0.99 1 1.01 1.03 0.96 1];
...
N_vec=[10:10:100 110:10:200 220:40:400];
K_vec=[1 4 8];
    ...
    for i=1:size(N_vec,2)
        ...
        for p=1:Num
            ...
            for ll=1:K               
                ...
                InterferenceRates(1,ll)=Pr*trace(Gk'*Gk);
                %pause
            end
            SumRates(InterferenceRates>I_T)=0;
...
analy3=1*Nr*log(1+Er*E2*eta_k1(1)*eta_k2(1)/((sigmaIn^2+sigmaN^2)*(E1*eta_k1(1)+E2*eta_k2(1))+(sigmaK^2+sigmaIk^2)*Nr(Er*eta_k1(1)+sigmaIn^2+sigmaN^2)));
